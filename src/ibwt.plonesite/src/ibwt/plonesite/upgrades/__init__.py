...
def upgrade_1000(context):
    ...
    #portal_setup.runImportStepFromProfile(
    #    'profile-ibwt.plonesite:default', 'jsregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.plonesite:default', 'cssregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.plonesite:default', 'portlets', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.plonesite:default', 'propertiestool', run_dependencies=False)
    log('v1000 applied')
